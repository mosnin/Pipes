...
const TOOLS = [
    ...
    {
        name: "get_graph",
        description: "Get the current nodes and pipes in a system. Requires schema:read capability.",
        inputSchema: {
            type: "object",
            properties: {
                systemId: { type: "string" },
    ...
    {
        name: "export_schema",
        description: "Export a system as full pipes_schema_v1 JSON. Requires schema:read capability.",
        inputSchema: {
            type: "object",
            properties: {
                systemId: { type: "string" },
    ...
    {
        name: "import_schema",
        description: "Import a pipes_schema_v1 JSON object as a new system. Requires import:write capability.",
        inputSchema: {
            type: "object",
            properties: {
                schema: { type: "object" },
    ...
    },
    {
        ...
        description: "Apply one or more graph mutations (addNode, addPipe, deleteNode, deletePipe, updateNode). Requires graph:write capability. Pass an array of action objects.",
        inputSchema: {
            type: "object",
            properties: {
                actions: {
    ...
    {
        name: "list_versions",
        description: "List all version snapshots of a system. Requires versions:read capability.",
        inputSchema: {
            type: "object",
            properties: {
                systemId: { type: "string" },
    ...
    {
        name: "create_version",
        description: "Create a named version snapshot of a system. Requires versions:write capability.",
        inputSchema: {
            type: "object",
            properties: {
                systemId: { type: "string" },
    ...
    },
    {
        ...
        description: "Get validation report for a system (errors, warnings, node/pipe counts). Requires validation:read capability.",
        inputSchema: {
            type: "object",
            properties: {
                systemId: { type: "string" },
    ...
    },
    {
        ...
        description: "Create a new system from a template. Requires templates:instantiate capability.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    {
        name: "add_comment",
        description: "Add a comment to a system or node. Requires comments:write capability.",
        inputSchema: {
            type: "object",
            properties: {
                systemId: { type: "string" },
