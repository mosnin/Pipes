...
import TrustSettingsPage from "@/app/(app)/settings/trust/page";
...
import FeedbackSettingsPage from "@/app/(app)/settings/feedback/page";
...
describe("route smoke", () => {
  ...
  it("has settings pages", () => {
    ...
    expect(TrustSettingsPage).toBeTypeOf("function");
    ...
    expect(FeedbackSettingsPage).toBeTypeOf("function");
