...
export default function HomePage() {
  ...
  return (
    <div className="section-stack">
      ...
      <section>
        <Card>
          <SectionHeader title="Pricing and rollout" description="Start free, then upgrade as collaboration and protocol scale expands." />
