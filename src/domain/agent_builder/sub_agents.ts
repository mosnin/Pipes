...
export const SubAgentTaskStatusSchema = z.enum(["created", "queued", "running", "completed", "failed", "blocked"]);
...
export type SubAgentContextPack = z.infer<typeof SubAgentContextPackSchema>;
