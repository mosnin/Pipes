...
export const securityControls: ReadonlyArray<SecurityControl> = [
  ...
  },
  {
    ...
    category: "Data",
    body:
      "Workspace owners can export the entire workspace as a looper_schema_v1 bundle from settings. Account deletion purges every per-workspace table within 30 days. Agent tokens can be revoked instantly.",
