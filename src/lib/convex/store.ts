...
import type { AgentConversationRecord, AgentRunnerMetricRecord, AgentTurnRecord, FeedbackEntryRecord } from "@/lib/repositories/contracts";
...
type DbShape = {
  ...
  builderStrategies: BuilderStrategy[];
  patternArtifacts: PatternArtifact[];
  reusableSubsystemPatterns: ReusableSubsystemPattern[];
  decisionRecords: DecisionRecord[];
  sessionContinuationRefs: SessionContinuationRef[];
  evaluationRecords: EvaluationRecord[];
  strategyPerformanceRecords: StrategyPerformanceRecord[];
  skillPerformanceRecords: SkillPerformanceRecord[];
  patternPromotionRecords: PatternPromotionRecord[];
  patternDemotionRecords: PatternDemotionRecord[];
  learningArtifacts: LearningArtifact[];
  runReviewers: RunReviewer[];
  sharedRunVisibility: SharedRunVisibilityState[];
  reviewThreads: ReviewThread[];
  reviewComments: ReviewComment[];
  reviewDecisionRecords: ReviewDecisionRecord[];
  approvalParticipantRecords: ApprovalParticipantRecord[];
  handoffRecords: HandoffRecord[];
  revisionRequests: RevisionRequest[];
  agentPolicies: AgentPolicy[];
  runPolicySnapshots: RunPolicySnapshot[];
...
function seed(): DbShape {
  ...
  return {
    ...
    builderStrategies: [],
    patternArtifacts: [],
    reusableSubsystemPatterns: [],
    decisionRecords: [],
    sessionContinuationRefs: [],
    evaluationRecords: [],
    strategyPerformanceRecords: [],
    skillPerformanceRecords: [],
    patternPromotionRecords: [],
    patternDemotionRecords: [],
    learningArtifacts: [],
    runReviewers: [],
    sharedRunVisibility: [],
    reviewThreads: [],
...
function readDb(): DbShape {
  ...
  return {
    ...
    builderStrategies: parsed.builderStrategies ?? [],
    patternArtifacts: parsed.patternArtifacts ?? [],
    reusableSubsystemPatterns: parsed.reusableSubsystemPatterns ?? [],
    decisionRecords: parsed.decisionRecords ?? [],
    sessionContinuationRefs: parsed.sessionContinuationRefs ?? [],
    evaluationRecords: parsed.evaluationRecords ?? [],
    strategyPerformanceRecords: parsed.strategyPerformanceRecords ?? [],
    skillPerformanceRecords: parsed.skillPerformanceRecords ?? [],
    patternPromotionRecords: parsed.patternPromotionRecords ?? [],
    patternDemotionRecords: parsed.patternDemotionRecords ?? [],
    learningArtifacts: parsed.learningArtifacts ?? [],
    runReviewers: parsed.runReviewers ?? [],
    sharedRunVisibility: parsed.sharedRunVisibility ?? [],
    reviewThreads: parsed.reviewThreads ?? [],
    reviewComments: parsed.reviewComments ?? [],
    reviewDecisionRecords: parsed.reviewDecisionRecords ?? [],
    approvalParticipantRecords: parsed.approvalParticipantRecords ?? [],
    handoffRecords: parsed.handoffRecords ?? [],
    revisionRequests: parsed.revisionRequests ?? [],
    agentPolicies: parsed.agentPolicies ?? [],
