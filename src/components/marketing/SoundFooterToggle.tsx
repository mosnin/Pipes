...
export function SoundFooterToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-full border border-black/[0.08] bg-white px-2.5 py-1 t-caption text-[#3C3C43] hover:text-[#111] hover:border-black/[0.16] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500"
    >
      <span
        aria-hidden="true"
        className={[
          "inline-block h-1.5 w-1.5 rounded-full transition-colors",
          enabled ? "bg-violet-600" : "bg-[#C7C7CC]",
        ].join(" ")}
      />
