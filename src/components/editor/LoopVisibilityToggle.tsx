  ...
  if (!canSetPrivate && !isPrivate) {
    return (
      <div className="flex items-center gap-1">
        <button
          className="flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium bg-[var(--surface-subtle)] text-ink-3 border border-line cursor-pointer hover:bg-[#EBEBED] transition-colors"
          onClick={() => {
        ...
        <button
          ...
          className="flex items-center justify-center w-6 h-6 rounded-md text-ink-3 hover:bg-[#EBEBED] hover:text-ink-2 transition-colors"
        >
          <Link2 size={12} />
        </button>
      </div>
