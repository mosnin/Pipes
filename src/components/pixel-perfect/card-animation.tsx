...
import TextBurnNeon from "./text-burn-neon";
    ...
    >
      ...
      <section className="mt-10 sm:mt-20 relative h-48 sm:h-60 flex justify-center items-start">
        ...
        >
          <div className="w-full flex justify-between items-center">
            <div className="flex gap-2 flex-1">
              <div className="w-[50%] bg-secondary h-5 rounded-md"></div>
              <div className="w-[10%] bg-secondary h-5 rounded-md"></div>
            </div>
        ...
        >
          <div className="w-full flex justify-between items-center ">
            <div className="flex gap-2 flex-1">
              <div className="w-[50%] bg-secondary-foreground/20 h-5 rounded-md"></div>
              <div className="w-[10%] bg-secondary-foreground/20 h-5 rounded-md"></div>
            </div>
        ...
        >
          <div className="w-full flex flex-col gap-3 justify-between items-center">
            ...
            <div className="bg-secondary w-full h-20 rounded-md flex justify-center items-end p-2">
